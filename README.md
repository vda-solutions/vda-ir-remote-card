...
- **Global Favorites** - Shared channel presets across all DTV sources with in-card editing
- **HA Device Support** - Control Apple TV, Roku, DirecTV, and other HA remote entities
...
### v2.0.0
- **Global Favorites** - Channel presets shared across all DTV sources
- **In-card Favorites Editor** - Add, edit, and delete favorites directly from the remote
- **Cross-card Sync** - Favorites update instantly across all remote cards
- **iPad Landscape Layout** - Optimized layout for landscape iPad displays
- **HA Device Remote** - Full remote controls for DirecTV, Apple TV, Roku, and other HA remote entities

### v1.9.0
- Dedicated projector screen remote layout with Up/Down/Stop controls
- Bump buttons for fine screen positioning (80ms pulses)
- Down button uses device-configured delay timing
- Screen linking integration with trigger devices

### v1.8.0
- Serial device remote support
- HA Remote device support (Apple TV, Roku, etc.)
- Improved group power commands with fallback support

### v1.7.0
- Enhanced device type detection
- Network device improvements
- Bug fixes for command sending
